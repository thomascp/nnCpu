...
HD_PWD='/home/neo/disk/fpga/nnCpu/vivado_prj/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_a7_nnCpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys_a7_nnCpu.tcl
